...
always @(alu_out, lsu_out, rd_mux1, imm, rd_mux0) begin: TOP_RD_DATA_LOGIC
    if (rd_mux1) begin
        if (rd_mux0) begin
            rd_data = imm;
        end
...
always @(id0_funct4_2, id0_funct4_3, id0_funct4_0, id0_funct4_9, ins, id0_ins96, id0_funct4_5, id0_funct4_8, id0_ins20, id0_funct4_4, id0_funct4_1) begin: TOP_ID0_ID_LOGIC
...
always @(cr0_int0_acc, cr0_int1_acc, cr0_TVEC2, cr0_TVEC1, cr0_TVEC3, cr0_int2_acc, cr0_TVEC0) begin: TOP_CR0_COMB_LOGIC
...
always @(cr0_PC, ret, branch, branch_offset, jmp, cr0_EPC, r6_r7_data) begin: TOP_CR0_COMB_LOGIC2
    if (ret) begin
        pc = cr0_EPC;
    end
...
always @(cr0_GIE, cr0_IE0, selector, cr0_IE2, cr0_IE3, cr0_TVEC2, cr0_EPC, cr0_TVEC1, cr0_PGIE, cr0_TVEC3, cr0_IE1, cr0_CPC, cr0_TVEC0) begin: TOP_CR0_COMB_LOGIC3
    case (selector)
        3'b000: begin
...
always @(alu_signal, alu0_shift_num, ds1_data, alu0_shift_right_signed_temp) begin: TOP_ALU0_SHIFT_RIGHT_LOGIC
...
always @(alu_signal, alu0_shift_left, alu0_shift_right_signed, ds2_data, alu0_shift_right_unsigned, imm, ds1_data) begin: TOP_ALU0_ALU_LOGIC
    case (alu_signal)
        4'b0000: begin
...
always @(ds1_data, r6_r7_data, mem_write, mem_read) begin: TOP_LSU0_LOGIC_2
    if ((mem_read | mem_write)) begin
        addr = r6_r7_data;
        wdata = ds1_data;
    end
...
always @(gpr0_r2, gpr0_r3, ds1_rx, gpr0_r7, gpr0_r0, gpr0_r5, gpr0_r4, gpr0_r6, gpr0_r1) begin: TOP_GPR0_DS1_DAT_LOGIC
    case (ds1_rx)
        3'b000: begin
            ds1_data = gpr0_r0;
        end
...
always @(gpr0_r2, gpr0_r3, ds2_rx, gpr0_r7, gpr0_r0, gpr0_r5, gpr0_r4, gpr0_r6, gpr0_r1) begin: TOP_GPR0_DS2_DATA_LOGIC
    case (ds2_rx)
        3'b000: begin
            ds2_data = gpr0_r0;
        end
